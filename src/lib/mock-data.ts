...
export const MOCK_POSTS = [
  ...
  },
  {
    ...
    requirements: 'Must have a good microphone and quiet recording space. Strong opinions about tech required!',
...
export const MOCK_NOTIFICATIONS = [
  ...
  },
  {
    ...
    title: 'Collab marked as completed!',
    body: 'Jake Rivera marked "30-day fitness challenge" as completed. Leave a review!',
    data: { match_id: 'mock-match-002' }, is_read: false, created_at: ago(0.5),
  },
  {
    id: 'mock-notif-010', user_id: '', type: 'new_review',
    title: 'You received a new review!',
    body: 'Jake Rivera left you a 5-star review',
...
export const MOCK_REVIEWS = [
  {
    ...
    rating: 5,
    review_text: 'Amazing collab partner! Aisha brought incredible recipe ideas and was super professional throughout.',
    created_at: ago(1),
    profiles: profileById('mock-002'),
  },
  {
    ...
    rating: 4,
    review_text: 'Jake was great to work with. Very organized and creative.',
    created_at: ago(1),
    profiles: profileById('mock-005'),
  },
]
